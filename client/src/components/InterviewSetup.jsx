...
function InterviewSetup({ onStart }) {
  ...
  return (
    <motion.div
      ...
      className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-emerald-50 px-4 py-12'>
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        <motion.div
          ...
          className='relative bg-gradient-to-br from-emerald-50 to-emerald-100 p-12 flex flex-col justify-center'>
        ...
        <motion.div
          ...
          <div className='space-y-6'>
            ...
            <select value={mode}
              ...
              className='w-full py-3 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition'>
            ...
            {!analysisDone && (
              <motion.div
                ...
                className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-emerald-500 hover:bg-emerald-50 transition'>
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className='mt-4 bg-emerald-600 text-white px-5 py-2 rounded-lg hover:bg-emerald-700 transition cursor-pointer'>
                    {analyzing ? (
                ...
                {skills.length > 0 && (
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {skills.map((s, i) => (
                        <span key={i} className='bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm'>{s}</span>
                      ))}
                    </div>
                  </div>
                )}
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.95 }}
              className='w-full disabled:bg-gray-600 bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md cursor-pointer '>
              {loading ? (
                <div className='flex items-center justify-center space-x-2'>
                  <div className='w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin' />
                  <span>Starting...</span>
