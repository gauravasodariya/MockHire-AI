...
function InterviewReport() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 px-4 sm:px-6 lg:px-10 py-12'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          <button
            onClick={() => navigate("/history")}
            className='mt-1 p-3 rounded-full bg-white shadow hover:shadow-md transition cursor-pointer'><FaArrowLeft className='text-gray-600' /></button>
              ...
              {questionWiseScore.map((q, i) => (
                <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                  ...
                  <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4'>
                    ...
                    <div className='bg-emerald-100 text-emerald-600 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit'>
                      {q.score ?? 0}/10
                    </div>
                  </div>

                  {q.answer && (
                    <div className='bg-gray-100 border border-gray-200 p-4 rounded-lg mb-4'>
