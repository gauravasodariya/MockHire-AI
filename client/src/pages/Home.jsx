        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={16} className="bg-emerald-50 text-emerald-600" />
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block'>
                <span className='bg-emerald-100 text-emerald-600 px-5 py-1 rounded-full'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-emerald-600 text-white px-10 py-3 rounded-full hover:bg-emerald-700 transition shadow-md cursor-pointer'>
                Start Interview
              </motion.button>
            ...
            <div className='flex flex-col md:flex-row justify-center items-center gap-10'>
              {
                [
                  ...
                  <motion.div key={index}
                    ...
                    className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all w-full md:w-1/3'>
                    <div className='bg-emerald-50 text-emerald-600 w-12 h-12 rounded-xl flex items-center justify-center mb-6'>
                      {item.icon}
                    </div>
                    <div className='text-xs text-emerald-600 font-semibold mb-2 tracking-wider'>{item.step}</div>
